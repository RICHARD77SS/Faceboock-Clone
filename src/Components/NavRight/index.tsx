...
const NavRight = () => {
  ...
  return (
    <NavRightSt>
      ...
      <Tooltip title='Criar'>
        <Button className='btn-nav main-criar' onClick={() => toggleCriar()}>
          <GrFormAdd />
        </Button>
      </Tooltip>
      {openCriar ?
      ...
      <Tooltip title='Messenger'>
        <Button className='btn-nav' onClick={() => toggleMess()}>
      ...
      <Tooltip title='Notificações'>
        <Button className='btn-nav' onClick={() => toggleNotification()}>
      ...
      {openNotification ?
        ...
        : null}
      <Tooltip title='Conta'>
        <Button className='btn-nav' onClick={() => toggleConta()}>
          <img width={20} className='image' src="https://i.postimg.cc/brczWrGr/richardsilva.jpg" alt="" />
        </Button>
      </Tooltip>
      {openConta ?
        <>
